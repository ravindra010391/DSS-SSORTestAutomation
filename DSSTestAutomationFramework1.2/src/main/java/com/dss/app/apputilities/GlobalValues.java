...
public interface GlobalValues {
	...
	//P2P Config Details
	public static final String P2P_STAGE_URL = "https://content.p2p.tribuneinteractive.com/";
	...
	//User Passwords
	public static final String PASSWORD1 = "tribune1";
	public static final String PASSWORD2 = "tribune2";
